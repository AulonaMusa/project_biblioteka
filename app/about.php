			...
			<div class="about">
				...
				<div class="team-member">
					...
					<div class="team-member-row">
						<div class="team-member-item1">
							<img class="team-member-photo" src="img/photo-member.jpg" alt="">
							<p class="team-member-position">Simply Dummy Text</p>
							<p class="team-member-name">Lorem Ipsum</p>
						</div>
						<div class="team-member-item2">
							<img class="team-member-photo" src="img/photo-member.jpg" alt="">
							<p class="team-member-position">Simply Dummy Text</p>
							<p class="team-member-name">Lorem Ipsum</p>
						</div>
						<div class="team-member-item3">
							<img class="team-member-photo" src="img/photo-member.jpg" alt="">
							<p class="team-member-position">Simply Dummy Text</p>
							<p class="team-member-name">Lorem Ipsum</p>
						</div>
						<div class="team-member-item4">
							<img class="team-member-photo" src="img/photo-member.jpg" alt="">
							<p class="team-member-position">Simply Dummy Text</p>
							<p class="team-member-name">Lorem Ipsum</p>
						</div>
					...
					<div class="team-member-row">
						<div class="team-member-item1">
							<img class="team-member-photo" src="img/photo-member.jpg">
							<p class="team-member-position">Simply Dummy Text</p>
							<p class="team-member-name">Lorem Ipsum</p>
						</div>
						<div class="team-member-item2">
