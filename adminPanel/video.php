			...
			<div class="page-content">
				<div class="page--content">
					...
					<div class="add_button-modal">
						...
						<button type="button" class="btn add-button" data-toggle="modal" data-target="#demoModal">Add Video</button>
								...
								<div class="modal-content">
									<div class="modal-body">
										...
										<div class="modal-row">
											...
											<input class="modal-input_item" type="url" required autofocus>
										</div>
										<div class="modal-row">
