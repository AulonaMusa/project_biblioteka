			...
			<div class="page-content">
				<div class="page--content">
					...
					<div class="add_button-modal">
						...
						<button type="button" class="btn add-button" data-toggle="modal" data-target="#demoModal">Add Team</button>
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-body">
										...
										<div class="modal-row">
											<label class="modal-label_item" name="position">Position: </label>
